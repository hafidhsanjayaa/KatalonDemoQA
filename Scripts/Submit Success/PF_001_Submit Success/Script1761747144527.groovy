...
WebUI.setText(findTestObject('Practice form/email - field'), Email)
...
WebUI.setText(findTestObject('Practice form/phoneNumber - field'), '1234567890')
...
WebUI.waitForElementVisible(findTestObject('Practice form/titlePopUp - txt'), 0)
